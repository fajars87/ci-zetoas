            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo base_url() ?>admin/kategori/edit/<?php echo $list['id'] ?>"><i class="fa fa-pencil"></i> EDIT</a> | <a href="<?php echo base_url() ?>admin/kategori/delete/<?php echo $list['id'] ?>"><i class="fa fa-close"></i> DELETE</a></td>
                    </tr>
                    <?php } ?>
                    </tbody>
                    <tfoot>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="name" placeholder="Nama Kategori" class="form-control" type="text">
